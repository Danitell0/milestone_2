...
def add_loops(maze, visited, rand_seed, target_loops):
...
def reduce_dead_ends(maze, visited, rand_seed, tolerance):
...
def generate(settings: MazeConfig):
    warnings = []
    ...
    if not settings.perfect:
        ...
        reduce_dead_ends(maze, visited, rand_seed, tolerance)
